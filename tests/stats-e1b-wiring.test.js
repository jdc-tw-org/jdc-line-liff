 ...
 *    （寫這一檔時另有兩個理由：本頁三發 batch 的子項守門在後端吃 `p.token`；會發 LINE 的 4 支與
 *     `getSeniorNotice` 的第二道在 gas 刀 5 還沒上線。兩格都已解除——gas `dbc8b17`（batch 子項）、
 *     `77ec561`＋`d07cf56`（刀 5），隨 gas main `04022c4` 於 2026-09-13 17:03:49 上線。
 *     但線上仍沒有人用 LINE 實際開過 stats，所以上面那句照樣成立。）
 *
